resource "aws_vpc" "alt_terraform_vpc" {
  cidr_block            = var.vpc_cidr_block.cidr_block
...
resource "aws_internet_gateway" "alt_terraform_igw" {
  vpc_id                = aws_vpc.alt_terraform_vpc.id
...
resource "aws_route_table" "main" {
  ...
  route {
    ...
    gateway_id          = aws_internet_gateway.alt_terraform_igw.id
  }
